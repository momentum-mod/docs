...
| Bonus Teleport     | **`"b", "bonus"`**                               | **[`mom_bonus <bonus>`](/command/mom_bonus)**                        | `/b 2` teleports the player to Bonus Track 2. `/b` with no parameter will cycle through bonus tracks. Use **`/r`** if you wish to restart the track.                                                                                 |
...
| Respawn            | **`"spawn", "respawn"`**                         | **[`mom_respawn`](/command/mom_respawn)**                            | `/respawn` will teleport the player to the map's initial spawn point.                                                                                                                                                                |
| Set Start Mark     | **`"setstart", "ss"`**                           | **[`mom_start_mark_set`](/command/mom_start_mark_set)**              | `/setstart` while standing in the track start zone will create a start mark, allowing `/r` to teleport you back to the specific spot you are in.                                                                                     |
...
| Stop Spectating    | **`"stopspec", "specstop"`**                     | **[`mom_spectate_stop`](/command/mom_spectate_stop)**                | `/stopspec` while watching a player in your lobby, or while in free roam, will exit spectate mode.                                                                                                                                   |
...
| Savestate Menu     | **`"savestate", "saveloc"`**                     | **[`hud_menu_show savestate`](/command/hud_menu_show/)**             | `/savestate` will open the savestate menu.                                                                                                                                                                                           |
